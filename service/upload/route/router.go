...
import (
	"fileserver_enc/service/upload/api"
...
func Router() *gin.Engine {
	...
	//router.POST("/file/abe", api.EncUploadHandler)

	//文件上传相关接口
	//router.POST("/file/upload", api.DoUploadHandler)
	router.POST("/file/upload", api.DoUploadBigDataHandler)
	// 秒传接口
	...
	//新增：加密上传
	//router.POST("/file/encupload", api.EncUploadHandler)
	router.POST("/file/encupload", api.EncUploadBigDataHandler)
